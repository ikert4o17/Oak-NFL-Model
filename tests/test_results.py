...
def test_grade_predictions_uses_closing_lines():
    pred=pd.DataFrame([{"game_id":"g1","season":2026,"week":1,"home_team":"A","away_team":"B","predicted_home_margin":4.0,"predicted_total":48.0,"spread_line":-2.5,"total_line":45.0}])
    finals=pd.DataFrame([{"game_id":"g1","home_score":24,"away_score":21,"closing_spread_line":-3.5,"closing_total_line":46.5}])
...
def test_weekly_summary_tracks_pushes():
    graded=pd.DataFrame([{"season":2026,"week":1,"su_result":"W","ats_result":"P","ou_result":"L"},{"season":2026,"week":1,"su_result":"L","ats_result":"W","ou_result":"W"}])
